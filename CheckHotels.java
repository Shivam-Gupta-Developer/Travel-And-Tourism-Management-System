...
public class CheckHotels extends JFrame implements Runnable{
    ...
    public void run(){
        String[] text = new String[]{"JW Marriott Hotel","Madarin Oriental Hotel","Four Seasons Hotel","Raddisson Blue Hotel","Classic Hotel","The Bay Club Hotel","Breeze Blow Hotel","Luxury Hotel","Happy Morning Hotel","River View Hotel"};
        try{
            for(int i=0;i<=9;i++){
