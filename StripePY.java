...
public class StripePY extends JFrame {
    ...
    StripePY(String user) {
        ...
        ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("icons/stripeY.png"));
        ...
        Submit.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    Stripe.apiKey = "sk_test_51Oj2BCSGmOhEr6FcRAlpkb4cLLRj0XY7uG3V2xC14zUSAlJ1thPkBL4A82kDX8BoD8svooexXonS1sJ3KlTFlwcg00o1PcZkci";
